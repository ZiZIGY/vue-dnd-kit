...
Now that you have installed Vue DnD Kit, you can proceed to the [Quick Start](/v1/guide/quick-start) guide to learn how to create your first drag and drop interface.
